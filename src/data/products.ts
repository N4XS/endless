...
export const products: Product[] = [
  {
    ...
    stock: 5,
    sku: "STARZZ-001",
    description: "La STARZZ Édition 2026 a été repensée pour une expérience encore plus intuitive. Plus facile à déplier que jamais, elle offre désormais deux points de vue grâce à la suppression de l'extension recouvrant l'échelle. Compacité, confort et toile Poly-Coton de haute qualité avec fenêtre panoramique sur les étoiles.",
    features: [
      "Dépliage simplifié — plus rapide et intuitif que les générations précédentes",
      "Double point de vue grâce à l'ouverture libérée côté échelle",
      "Toile résistante et aérée en Poly-Coton de haute qualité 280g/m²",
      "Fenêtre panoramique offrant une vue sur les étoiles",
