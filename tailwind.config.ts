...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'hero': ['4.5rem', { lineHeight: '1.05', fontWeight: '600', letterSpacing: '-0.02em' }],
        'display': ['3rem', { lineHeight: '1.1', fontWeight: '600', letterSpacing: '-0.02em' }],
        'headline': ['2rem', { lineHeight: '1.2', fontWeight: '600', letterSpacing: '-0.01em' }],
        'title': ['1.5rem', { lineHeight: '1.3', fontWeight: '600' }],
        'large': ['1.25rem', { lineHeight: '1.5', fontWeight: '400' }],
      },
      colors: {
        // Nouvelles couleurs épurées
      ...
      boxShadow: {
        ...
        'hero': '0 4px 12px -2px rgb(0 0 0 / 0.08)',
      },
      borderRadius: {
        lg: "var(--radius)",
